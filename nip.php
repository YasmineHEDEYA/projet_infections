...
<head>
    ...
    <title>Numéro Identifiant Permanent</title>
</head>

<body>
    <div class="col-md-4 offset-md-4">

            <form class="text-center p-4" method='POST' action="infection1.php?SearchCritere=infection.nip">
                
                <legend>
                    <h5 style="text-shadow: 2px 2px 5px #24363f">Veuillez saisir le Numéro d'Identification Permanent du patient concerné</h5>
                <br/>
                <p class="float-sm-left">* Information requise</p>
                <input type="text" class="form-control" placeholder="Numéro d'Identifiant Permanent*" pattern="[0-9]{6}" maxLength='6' oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="nipsearch" name='nip' required>
