            ...
            <option   selected>Service*</option>
              ...
              <br/>
                ...
                <div id="date-picker" class="md-form md-outline input-with-post-icon datepicker">
                    <input name='date_declaration' placeholder="Date de déclaration*" type="test" onfocus="(this.type='date')" onblur="(this.type='text')" name="date_declaration" class="form-control" required>
                    <i class="fas fa-calendar input-prefix" tabindex=0></i>
                </div>
                <br />
                <div id="date-picker" class="md-form md-outline input-with-post-icon datepicker">
                    <input name='date_fin' placeholder="Date de fin" type="test" onfocus="(this.type='date')" onblur="(this.type='text')" name="date_guerison" class="form-control">
                    <i class="fas fa-calendar input-prefix" tabindex=0></i>
                </div>
                <br />
