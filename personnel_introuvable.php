...
<head>
    ...
    <title>Personnel introuvable</title>
</head>
...
<body>
    ...
    <div class="col-md-4 offset-md-4">
        ...
        <form class="text-center p-4" action="formulaire.php">
            <p class="h2 mb-2" style="color:#93acb9; text-shadow: 2px 2px 5px#24363f">Personnel introuvable</p>
            <br />
            <br />
            <h5 style="text-shadow: 2px 2px 5px #24363f">Vérifiez votre saisie</h5>
            <h5 style="text-shadow: 2px 2px 5px #24363f">Contactez l'administrateur en cas de problème</h5>
            <br />
