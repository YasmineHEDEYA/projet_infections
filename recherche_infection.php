...
<head>
    ...
    <title>Visualisation des infections déclarées</title>
</head>
...
<body>
    <div class="col-md-4 offset-md-4">
        ...
        <form method="post" class="text-center p-4">
            <p class="h2 mb-2" style="color:#93acb9; text-shadow: 2px 2px 5px#24363f">CONSULTER UNE INFECTION</p>
            <br />
            <legend>
                <h5 style="text-shadow: 2px 2px 5px #24363f">Veuillez choisir votre critère de recherche</h5>
            </legend>
            <br />
            ...
            <select class="custom-select" name="SearchCritere" placeholder="Critère" required>
                <option selected disabled value="">Critère</option>
                <option value="infection.nip">NIP</option>
